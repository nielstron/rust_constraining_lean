...
private theorem lvalCheckerFuelBound_le_termFuel_of_copy {fuel : Nat}
    {lv : LVal} :
...
private theorem lvalCheckerFuelBound_le_termFuel_of_move {fuel : Nat}
    {lv : LVal} :
...
private theorem lvalCheckerFuelBound_le_termFuel_of_borrow {fuel : Nat}
