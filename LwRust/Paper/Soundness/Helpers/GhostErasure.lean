  ...
  exact TermTyping.rec
    ...
    (by
      intro env₁ env₂ env₃ env₄ env₅ typing lifetime condition trueBranch
        ...
        henvJoin hsameLeft hsameRight hwellJoin hcontained hcoherent
        hlinear hborrowSafe hresultSafe ihCondition ihTrue ihFalse
        hfresh hstore hnot
      ...
      exact ⟨TermTyping.ite hconditionErased htrueErased hfalseErased
        ...
        (ContainedBorrowsWellFormed.erase_ghost hcontained hfreshJoin)
