...
* `Corollary_4_14_BorrowSafety`          — Corollary 4.14 (corrected dynamic and strengthened core forms)
...
* `Appendix9.Lemma_9_3_Location`                — location and partial-value conclusion; checked lifetime mismatch
* `Appendix9.Corollary_9_4_ReadPreservation`    — defined full-value read with actual slot lifetime
* `Appendix9.Lemma_9_5_DropPreservation`        — strict store-invariant drop theorem and abstract-store obstruction
* `Appendix9.Lemma_9_6_UpdatePreservation`      — full-value operational update analogue and independent support
* `Appendix9.Lemma_9_7_ValueTyping`             — proven
* `Appendix9.Lemma_9_8_AliasPreservation`       — independent shared strict one-step theorem and validity projection
* `Appendix9.Lemma_9_9_ValuePreservation`       — shared-theorem value projection; runtime redexes supported
* `Appendix9.Lemma_9_10_StorePreservation`      — shared-theorem strict store projection; runtime redexes supported
-/
